...
public class AttackJoystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        // Se superiamo la dead zone, iniziamo il dragging (usando la distanza calcolata)
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        // Logica di attacco basata sui valori salvati (usando la distanza calcolata)
        if (wasDragging && direction.magnitude > deadZone * calculatedMaxDistance)
        {
    ...
    {
        CalculateMaxDistance();
        Debug.Log($"New Attack Joystick Max Distance: {calculatedMaxDistance}px");
    }
